...
public class TicketMachine
{
    ...
    private int total;
    //se crea variable para indicar si ahi premio o no, verdadero o falso
    private boolean maquinaPremios; //prize es premio en ingles
    //almacena el numero de billetes que lleva vendidos la maquina
     ...
     */
    public TicketMachine(int cost, boolean winner, int maximoBilletes)//se añade el parametro
    {
        
        maquinaPremios = winner;//lo que el usuario intruduce
    ...
    public void printTicket()
    {
        if(billetesVendidos < numeroMaximoBilletes){
            ...
            // Simulate the printing of a ticket.
                ...
                /**se compreba aqui si la maquina da premios, si lo da lo imprimo
                   * el tiquet de regalo, si no no lo imprimo
                     */
         ...
         */
            ...
            System.out.println("Vendidos todos los billetes disponibles.");
        }
